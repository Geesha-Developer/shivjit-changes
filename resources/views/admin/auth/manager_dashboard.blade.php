                ...
                <div class="tab-pane fade" id="carriers" role="tabpanel" aria-labelledby="carriers-tab">
                   <button type="button" style="float: unset;padding: 8px 9px !important;margin-top: 3px;" class="btn btn-success toggleBlurButton"><i class="fa fa-eye"></i></button>
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            <thead>
                                <tr>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier</th>
                                    <th style="background: #555555 !important;color: #fff !important;"># of Load</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Gross Revenue</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Pay</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Profit</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Miles</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Revenue / Mile</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Pay / Mile</th>
                ...
                <div class="tab-pane fade" id="customers" role="tabpanel" aria-labelledby="customers-tab">
                  <button type="button" style="float: unset;padding: 8px 9px !important;margin-top: 3px;" class="btn btn-success toggleBlurButton"><i class="fa fa-eye"></i></button>
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            <thead>
                                <tr>
                                    <th style="background: #555555 !important;color: #fff !important;">Customer</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Gross Revenue</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Pay</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Margin</th>
                                    <th style="background: #555555 !important;color: #fff !important;">No. Of Loads</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Open Loads</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Delivered Loads</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Completed Loads</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="tab-pane fade" id="dispatchers" role="tabpanel" aria-labelledby="customers-tab">
                  <button type="button" style="float: unset;padding: 8px 9px !important;margin-top: 3px;" class="btn btn-success toggleBlurButton"><i class="fa fa-eye"></i></button>
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            <thead>
                                <tr>
                                    <th style="background: #555555 !important;color: #fff !important;">Dispatcher</th>
                                    <th style="background: #555555 !important;color: #fff !important;">No of Load</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Revenue</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Amount</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Margin </th>
                                    <th style="background: #555555 !important;color: #fff !important;">Open Loads</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Delivered Loads</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Invoiced Loads</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="tab-pane fade" id="loads" role="tabpanel" aria-labelledby="customers-tab">
                  <button type="button" style="float: unset;padding: 8px 9px !important;margin-top: 3px;" class="btn btn-success toggleBlurButton"><i class="fa fa-eye"></i></button>
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            <thead>
                                <tr>
                                    <th style="background: #555555 !important;color: #fff !important;">Load No</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Status</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Created</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Dispatcher</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Customer</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Shipper</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Ship Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Location</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Consignee</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Delevery Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Delivery Location</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="customers-tab">
                   <button type="button" style="float: unset;padding: 8px 9px !important;margin-top: 3px;" class="btn btn-success toggleBlurButton"><i class="fa fa-eye"></i></button>
                     <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                        <thead>
                            <tr>
                                <th style="background: #555555 !important;color: #fff !important;">Sales Rep</th>
                                <th style="background: #555555 !important;color: #fff !important;">No of Load</th>
                                <th style="background: #555555 !important;color: #fff !important;">Gross Revenue</th>
                                <th style="background: #555555 !important;color: #fff !important;">Carrier Pay</th>
                                <th style="background: #555555 !important;color: #fff !important;">Margin</th>
                                <th style="background: #555555 !important;color: #fff !important;">Open Load</th>
                            </tr>
                        </thead>
                        <tbody>
                         ...
                         <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background: #555555 !important;color: #fff !important;">Load Shipper Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Load Type</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Advance Payment</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Delivery Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Due Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Mark Payment Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Fee</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Shipper Rate</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Invoice No</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Invoice Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Customer Payment Amount</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Customer Payment Received Date</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Customer Payment</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Carrier Payment</th>
                                    <th style="background: #555555 !important;color: #fff !important;">Margin</th>
                                </tr>
                            </thead>
                            <tbody>
