                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <p>Credit Limit: <span id="credit_limit_display"></span></p>
                                                    <p>Remaining Credit: <span id="remaining_credit_display"></span></p>
                                                </div>
                                            </div>
                                        </div>
    ...
    <table class="table table-bordered" id="consigneeTable">
        ...
        <tbody>
            ...
            <tr id="consigneeRow{{ $key + 1 }}">
                ...
                <td style="padding: 7px;">
                    <input class="form-control" name="load_consignee_location_{{ $key + 1 }}" id="load_consignee_location_{{ $key + 1 }}" value="{{ $consigneeLocation[$key]['location'] ?? '' }}" readonly title="{{ $consigneeLocation[$key]['location'] ?? '' }}">
                </td>
                <td style="padding: 7px;">
